...
if ( ! function_exists ( 'oxsn_list_pages_by_taxonomy_plugin_nav_item' ) ) {

	add_action('admin_menu', 'oxsn_list_pages_by_taxonomy_plugin_nav_item', 99);
	function oxsn_list_pages_by_taxonomy_plugin_nav_item() {

		add_submenu_page('oxsn-dashboard', 'Oxsn List Pages By Taxonomy', 'List Pages By Taxonomy', 'manage_options', 'oxsn-list-pages-by-taxonomy', 'oxsn_list_pages_by_taxonomy_plugin');

	}

}

if ( !function_exists('oxsn_list_pages_by_taxonomy_plugin') ) {

	function oxsn_list_pages_by_taxonomy_plugin() {
	...
	?>
		...
		<div class="wrap oxsn_settings_page">
			...
			<h2>Oxsn List Pages By Taxonomy Plugin</h2>
